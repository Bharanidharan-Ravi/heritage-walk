...
const PATHS = {
  ...
  kids: (
    <>
      <circle cx="7" cy="5.3" r="1.8" />
      <circle cx="14" cy="7.3" r="1.4" />
      <path d="M3.2 15.5c0-2.8 1.8-4.5 3.8-4.5s3.8 1.7 3.8 4.5" />
      <path d="M11.5 12.2c1.3.3 2.5 1.5 2.5 3.6" />
    </>
  ),
  age: (
    <>
      <path d="M10 17.5c3.6-2 5.5-4.8 5.5-8V4.8L10 2.5 4.5 4.8V9.5c0 3.2 1.9 6 5.5 8Z" />
      <path d="M7.5 9.5 9 11l3.5-4" />
    </>
  ),
  accommodation: (
    <>
      <path d="M3 15.5V6.5M3 15.5h14M17 15.5v-4a2 2 0 0 0-2-2H9.5v6" />
      <rect x="3" y="8" width="6.5" height="3.5" rx="1" />
    </>
  ),
