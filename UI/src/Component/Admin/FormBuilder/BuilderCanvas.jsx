...
import { formBuilderConfig, fieldTypeCatalog, isDisplayOnly } from "../../Config/formBuilder.config";
...
export default function BuilderCanvas({
  ...
  onDuplicate,
  onWidthChange,
  drag,          // { kind: "new", type } | { kind: "move", index } | null
  onDragEnd,
  onDragStartMove,
}) {
  ...
  const handleDropOnCanvas = (e) => {
    ...
    if (drag?.kind === "new") onInsertNew(drag.type, target);
  ...
  return (
    ...
    >
      ...
      <div className="pointer-events-none">
        <RenderedField field={field} value="" disabled compact />
      </div>
